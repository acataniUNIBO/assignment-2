...
public class App {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String filePath =  System.getProperty("user.dir") + "/assignment-2/packageReport/app/Car.java"; //creo il path del file Car.java che ha 3 classi
        ...
        String packages = new String(); //package che verrà trovato nel file
        ...
        VoidVisitor<String> packageCollectorVisitor = new PackageCollector(); //Creo un oggetto di tipo packageCollector (implementazione sotto) che può visitare il package
        ...
        methodCollectorVisitor.visit(cu, methods); // visito i metodi col VoidVisitor inizializzato sopra e le inserisco nell'arrayList dichiarato sopra ("methods")
...
class InterfaceCollector extends VoidVisitorAdapter<List<String>> {
    @Override
...
class PackageCollector extends VoidVisitorAdapter<String> {
    @Override
    public void visit(PackageDeclaration pkg, String collector) {
        super.visit(pkg, collector);
        collector = pkg.getNameAsString();
    }
}
